...
TELEGRAM_BOT_TOKEN = os.environ.get("PRIME_TELEGRAM_BOT_TOKEN", os.environ.get("TELEGRAM_BOT_TOKEN", "8354688066:AAFgHUwEAS_JHhuM2XEKXEFXG8ShGuxiz5A"))
TELEGRAM_CHAT_ID = os.environ.get("PRIME_TELEGRAM_CHAT_ID", os.environ.get("TELEGRAM_CHAT_ID", "8373909846"))
MAX_RETRIES = 3
