...
from granas_module.back_contact_physics import BackContactPhysics
...
class GranasProductionModule:
    ...
    back_contact: BackContactPhysics = field(default_factory=BackContactPhysics)
    ...
    t80_years: float = 0.0
    weight_kg: float = 0.0
    ammonia_yield_kg_year: float = 0.0
    ammonia_yield_g_day: float = 0.0
    ...
    def compute(self) -> "GranasProductionModule":
        ...
        # ── Ammonia Co-Production (Back Contact) ─────────────
        nh3_results = self.back_contact.calculate_module_yield(self.active_area_m2)
        self.ammonia_yield_kg_year = nh3_results["ammonia_yield_kg_year"]
        self.ammonia_yield_g_day = nh3_results["ammonia_yield_g_day"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "ammonia_yield_kg_year": round(self.ammonia_yield_kg_year, 2),
            "ammonia_yield_g_day": round(self.ammonia_yield_g_day, 1),
        }
    ...
    def summary(self) -> str:
        ...
        lines = [
            ...
            "",
            " ANNUAL ENERGY & CO-PRODUCTS",
            f"   Capacity Factor:  {d['capacity_factor']}  (Mexico)",
            f"   Annual Energy:    {d['annual_energy_kWh']} kWh/module/year",
            f"   Green Ammonia:    {d['ammonia_yield_kg_year']} kg/module/year  ({d['ammonia_yield_g_day']} g/day)",
            "",
            " DURABILITY",
