...
class GranasVZA400Dynamics(HJBDynamics):
    """
    Granas VZA-400 PV-HB integrated state-space model.
    State: [E_PV (MW), T_r (°C), P_r (bar), S_H2 (0.0-1.0)]
    Control: u_hb (MW) -> Power dispatched to VZA-400 reactor.
    """
