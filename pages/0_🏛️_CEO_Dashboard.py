...
#  DIVISION SUMMARY
# ═══════════════════════════════════════════
st.subheader("🏛️ Division Portfolio")

d1, d2, d3, d4, d5, d6 = st.columns(6)
d1.metric("☀️ Granas Solar", "25.6% PCE", "Perovskite-Si Tandem")
d2.metric("📈 Eureka Trading", "VIX-Regime", "Volatility Targeting")
d3.metric("🧠 SIBO API", "SaaS Live", "GP Optimizer")
d4.metric("🚀 PRIMEngines", "3 Engines", "NH₃ / H₂ / PEM")
d5.metric("🔋 Battery", "100 MWh", "LFP + Solid-State")
d6.metric("🌀 Wind", "15 MW", "H₂-Ready Turbines")

st.divider()

# ═══════════════════════════════════════════
#  FINANCIAL PROJECTIONS — GRANAS SCALE
# ═══════════════════════════════════════════
...
fig.add_trace(go.Scatter(x=years, y=energy_rev + carbon_rev + h2_rev, name="+ Green H₂", fill="tonexty",
    fillcolor="rgba(0,191,255,0.2)", line=dict(color="#00BFFF")))
fig.add_trace(go.Scatter(x=years, y=energy_rev + carbon_rev + h2_rev + nh3_rev, name="+ Green NH₃", fill="tonexty",
...
with col1:
    st.markdown("#### ☀️ Granas Solar Stack")
    st.markdown("""
    | Layer | Technology |
    |-------|-----------|
    | Absorber | FAPbI₃ Perovskite |
    | Rear Cell | TOPCon Si HJT |
    | Encapsulation | ETFE + Mn²⁺ |
...
repos = [
    ("PRIMEnergeia-Sovereign", "18-page Streamlit Command Center", "🟢"),
    ("Eureka-Sovereign", "VIX-Regime Trading Engine + GitHub Actions", "🟢"),
    ("Granas-Sovereign", "SIBO Bayesian Optimizer (GP/Matern)", "🟢"),
    ("Granas-CFRP", "Carbon Fiber Reinforced Polymer Substrate", "🟢"),
    ("Granas-GHB", "Granular Heat Bed Thermal Management", "🟢"),
    ("Granas-Albedo", "Green-Wavelength Reflective Cooling", "🟢"),
    ("Granas-ETFE", "ETFE Encapsulation + Mn²⁺ Passivation", "🟢"),
    ("Granas-TOPCon", "TOPCon Silicon Heterojunction", "🟢"),
    ("Granas-Blueprint", "System Architecture & Integration", "🟢"),
    ("Granas-Metrics", "Performance KPIs & Validation", "🟢"),
    ("Granas-Scale", "100MW/1GW/10GW Industrial Calculator", "🟢"),
    ("PRIMEngines-AICE", "Ammonia Internal Combustion Engine", "🟢"),
    ("PRIMEngines-PEM", "PEM Fuel Cell Power Bank", "🟢"),
    ("PRIMEngines-HYP", "Hydrogen Gas Turbine 100kW", "🟢"),
    ("PRIMEnergeia-Battery", "Grid-Scale Energy Storage", "🟢"),
    ("PRIMEcycle", "Perovskite Recycling Platform", "🟢"),
    ("PRIM-Wind", "Hydrogen-Ready Wind Energy", "🟢"),
]
...
#  COMPETITIVE MOAT
# ═══════════════════════════════════════════
st.subheader("🛡️ Competitive Moat")
