...
ax.set_title('REFERENCIA DE MERCADO (DATOS PÚBLICOS) - NODO VZA-400', fontsize=14, color='white')
...
pdf.cell(0, 10, f'Análisis de Ciclo de 24 Horas (Datos Públicos CENACE) | Nodo: 05-VZA-400 | Fecha: {datetime.date.today()}', 0, 1, 'L')
pdf.ln(10)
